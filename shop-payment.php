...
<html lang="en">
  <head>
    ...
    <title>Checkout &mdash; BuyTheBella</title>
      ...
      <div class="payment-inner">
        ...
        <div class="payment-success" id="payment-success" style="display: none">
          <div class="success-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="width: 56px; height: 56px; stroke: #22c55e">
        ...
        <div id="payment-form-view">
          ...
          <div class="step-panel" id="step-2">
            ...
            <div class="row g-3">
              <div class="col-12 col-md-6">
                <div class="payment-card h-100">
                  ...
                  <div style="margin-top: 0.5rem; font-size: 0.84rem; line-height: 1.7; text-align: center">
                    ...
                    <div>
                      <span style="color: var(--text-muted); font-size: 0.8rem">GCash #:</span>
                      <strong>0960 686 7753</strong>
                    </div>
                    <div>
                      <span style="color: var(--text-muted); font-size: 0.8rem">Account Name:</span>
                      <strong>Account Name Here</strong>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6">
                <div class="payment-card h-100">
                  ...
                  <ol class="payment-steps">
                    <li>
                      <span>Open your <strong>GCash app</strong> and tap <em>Pay QR</em>.</span>
                    </li>
                    <li><span>Scan the QR code on the left.</span></li>
                    <li>
                      <span>Enter the <strong>exact total amount</strong> shown above.</span>
                    </li>
                    <li>
                      <span>Complete the payment and <strong>screenshot</strong> the confirmation screen.</span>
                    </li>
                    <li>
                      <span>Upload the screenshot below and enter your reference number, then tap <em>Confirm Payment</em>.</span>
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <div class="payment-card" style="margin-top: 1rem">
              ...
              <div class="proof-upload-zone" onclick="document.getElementById('proof-file').click()">
                ...
                <div class="proof-upload-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="width: 32px; height: 32px; opacity: 0.4">
              ...
              <div class="payment-help-line">
                <span>Need help?</span>
                <a href="tel:+639606867753" title="Call / SMS" class="payment-help-icon" style="background: #25d366"><i class="bi bi-telephone-fill"></i></a>
            ...
            <div class="no-refund-notice" style="margin-top: 1rem">
              ...
              <p>
                Read our full
                <a href="shop-terms.php" target="_blank" style="color: inherit; font-weight: 600; text-decoration: underline">Terms &amp; Conditions and Privacy Policy</a>.
              </p>
    ...
    <script>
      ...
      function validateStep(n) {
        if (n === 1) {
          ...
          if (!city) {
            showToast("Please select your city / municipality.");
            return false;
          }
          if (!street) {
      ...
      // Populate review step with address and shipping fee
      function populateReview() {
        ...
        if (summaryEl) {
          summaryEl.innerHTML = `<strong>${name}</strong><br>${phone} &bull; ${email}<br>${addrParts.join(", ")}`;
        }
      ...
      function updateShippingFee() {
        ...
        else if (name.includes("mindanao") || name.includes("davao") || name.includes("zamboanga") || name.includes("soccsksargen") || name.includes("caraga") || name.includes("bangsamoro") || name.includes("barmm")) fee = 160;
        else fee = 100;
      ...
      // Enable confirm button only when no-refund checkbox is checked
