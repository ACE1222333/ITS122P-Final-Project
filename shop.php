...
<html lang="en">
  <head>
    ...
    <title>BuyTheBella — Second-Hand Clothing</title>
  ...
  <body>
    ...
    <div class="hero">
      ...
      <div class="hero-content">
        <div class="hero-tag">Pre-Loved Fashion Since 2021</div>
        <h1>Secondhand Finds,<br />Carefully Curated</h1>
        <p>BuyTheBella began as a one-person passion project on Carousell in 2021. Every piece is personally handpicked — quality you can trust, at a price that makes sense.</p>
    ...
    <div class="promo-strip">
      <h2>Born on Carousell,<br />Built with Purpose</h2>
      <p>What started as a humble Carousell seller profile in 2021 has grown into BuyTheBella — a curated secondhand shop where every piece is hand-selected, cleaned, and quality-checked. Shop with us and give great clothes the second chapter they deserve.</p>
    ...
    <div class="feat-info">
      ...
      async function buildReviewsStrip() {
        ...
        try {
          ...
          if (!list.length) {
            strip.innerHTML = '<div class="loading-state" style="font-size:0.82rem;">No reviews yet.</div>';
            return;
          }
