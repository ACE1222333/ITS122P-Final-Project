...
<style>
  ...
  .contact-hero-left .subtitle { color: var(--text-muted); font-size: 0.93rem; line-height: 1.75; margin-bottom: 2rem; }
  ...
  .contact-card-label { font-size: 0.68rem; font-weight: 600; letter-spacing: .08em; text-transform: uppercase; color: var(--text-muted); }
  ...
  @media (max-width: 768px) {
    ...
    .contact-hero-left { padding: 2.5rem 1.5rem; }
  }
</style>
</head>
<body>
...
<div class="contact-hero">
  <div class="contact-hero-left">
    ...
    <div class="d-flex flex-column gap-3">
      ...
      <a class="contact-card" href="tel:+639XXXXXXXXX">
