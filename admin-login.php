...
<html lang="en">
  <head>
    ...
    <title>Admin Login — BuyTheBella</title>
  ...
  <body>
    <div class="card">
      <div class="brand-wrap">
        ...
        <div class="brand">BuyTheBella</div>
      </div>
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          <input type="email" id="email" placeholder="admin@example.com" autocomplete="email" onkeydown="if (event.key === 'Enter') login();" />
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          <input type="password" id="pass" class="pass-input" placeholder="Enter your password" autocomplete="current-password" onkeydown="if (event.key === 'Enter') login();" />
    ...
    <script>
      ...
      (function () {
        try {
          const sess = JSON.parse(localStorage.getItem("buythebella_session") || "null");
      ...
      async function login() {
        ...
        try {
          ...
          try {
            ...
            showError("Server error — check that XAMPP is running and you are on http://localhost/");
            return;
          }
