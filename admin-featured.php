...
<title>Featured Products — Carousell Admin</title>
...
async function confirmPick() {
  if (!pickSelected) { showToast('Please select a product.'); return; }
  if (products.filter(p => p.featured).length >= 4) { showToast('Already 4 featured products.'); return; }
