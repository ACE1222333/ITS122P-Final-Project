...
<html lang="en">
  <head>
    ...
    <title>Products — BuyTheBella Admin</title>
  ...
  <body>
    <div class="shell">
      ...
      <main class="main">
        ...
        <div style="margin-bottom: 0.8rem">
          <input class="search-bar" type="text" placeholder="Search products by name…" id="search-input" oninput="applyFilters()" style="margin-bottom: 0" />
        </div>
    ...
    <script>
      ...
      function applyFilters() {
        ...
        countEl.textContent = list.length === products.length ? `${products.length} product${products.length !== 1 ? "s" : ""}` : `${list.length} of ${products.length} products`;
      }
      ...
      function confirmDeleteProduct(id) {
        ...
        if (!p) return;
        openConfirm("Delete Product?", `Delete "${p.name}"? This cannot be undone.`, () => deleteProduct(id, () => fetchProducts(applyFilters)), "Delete", true);
      }
    </script>
  </body>
</html>
