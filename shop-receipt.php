...
.doc-back {
  ...
  margin-bottom: 1.6rem; background: none; border: none;
...
.doc-tagline { font-size: 0.75rem; color: var(--text-muted); margin-bottom: 1.4rem; }
.doc-title-row {
  display: flex; justify-content: space-between; align-items: flex-start;
  flex-wrap: wrap; gap: 0.5rem; margin-bottom: 1.4rem;
  padding-bottom: 1rem; border-bottom: 1px solid var(--border);
}
.doc-title { font-family: 'Bebas Neue', sans-serif; font-size: 1.6rem; letter-spacing: 0.08em; }
.doc-number { font-size: 0.78rem; color: var(--text-muted); font-family: monospace; margin-top: 0.3rem; }

.doc-meta-grid {
  display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem 1.5rem;
  margin-bottom: 1.4rem;
}
@media (max-width: 480px) { .doc-meta-grid { grid-template-columns: 1fr; } }
.doc-meta-label { font-size: 0.65rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.15rem; }
.doc-meta-value { font-size: 0.84rem; font-weight: 500; }
.doc-meta-approved { color: #16a34a; }

.doc-address { margin-bottom: 1.4rem; }
.doc-divider { border: none; border-top: 1px solid var(--border); margin: 1.2rem 0; }

.doc-table { width: 100%; border-collapse: collapse; font-size: 0.82rem; margin-bottom: 0.5rem; }
.doc-table th { text-align: left; font-size: 0.65rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; color: var(--text-muted); padding: 0 0 0.6rem; border-bottom: 1px solid var(--border); }
.doc-table th:not(:first-child) { text-align: right; }
.doc-table td { padding: 0.55rem 0; border-bottom: 1px solid var(--border); vertical-align: top; }
.doc-table td:not(:first-child) { text-align: right; }
.doc-table tbody tr:last-child td { border-bottom: none; }
.doc-table tfoot td { padding-top: 0.5rem; color: var(--text-muted); font-size: 0.82rem; }
.doc-table tfoot .total-row td { font-weight: 700; font-size: 0.9rem; color: var(--text); border-top: 1px solid var(--border); padding-top: 0.65rem; }

.doc-footer-note {
  font-size: 0.76rem; color: var(--text-muted); text-align: center;
  padding-top: 1rem; border-top: 1px solid var(--border); margin-top: 0.5rem; line-height: 1.6;
}
.doc-actions {
...
.btn-doc-print {
  ...
  padding: 0.75rem 1.6rem; font-family: 'DM Sans', sans-serif;
  font-size: 0.86rem; font-weight: 600; cursor: pointer; transition: opacity 0.2s;
}
.btn-doc-print:hover { opacity: 0.85; }
body.dark .btn-doc-print { color: #0f0f0f; }
.btn-doc-back {
...
@media print {
  .doc-back, .doc-actions, nav, footer, .topnav, .sidebar { display: none !important; }
  .doc-wrap { padding: 0; }
  .doc-card  { border: none; border-radius: 0; padding: 0; }
}
</style>
</head>
<body>
...
function renderReceipt(r) {
  ...
  document.getElementById('page-wrap').innerHTML = `
    ...
    <div class="doc-card">
      <div class="doc-logo">ByTheBel</div>
      ...
      <div class="doc-footer-note">
        Thank you for your purchase! This is your official payment receipt from ByTheBel.
      </div>
    </div>
