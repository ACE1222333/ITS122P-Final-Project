...
<title>Dashboard — Carousell Admin</title>
...
.pending-table-row:hover { background: var(--bg); }
.pending-id { font-family: 'DM Sans', sans-serif; font-weight: 700; font-size: 0.8rem; }
.pending-ref { font-size: 0.72rem; color: var(--text-muted); font-family: monospace; }
.pending-empty {
  padding: 2.5rem;
  text-align: center;
  font-size: 0.84rem;
